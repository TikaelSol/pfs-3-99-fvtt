...
const symlinkPath = path.resolve(dataPath, "modules", "pfs-3-99-fate-in-the-future");
...
if (symlinkStats) {
    ...
    const proceed = (
        await prompts({
            ...
            name: "value",
            initial: false,
            message: `A "pfs-3-99-fate-in-the-future" ${atPath} already exists in the "systems" subfolder. Replace with new symlink?`,
        })
    ).value;
    if (!proceed) {
